...
$result2=mysqli_query($con,"Select Auto_increment as id from information_schema.Tables where (TABLE_name='tblsales1')");
$count=mysqli_fetch_assoc($result2);
$row=$count['id'];
if (isset($_POST['delete'])){
    $store_id=$_POST['id'];
    $result10=mysqli_query($con,"Delete from tblsales2 where sales_id='$store_id'");
    $result9=mysqli_query($con,"Delete from tblsales1 where sales_id='$store_id'");
    if ($result9){
        echo "<script>alert('Data Deleted Successfully'); window.location.href='sale_invoice.php';</script>";
    }
}
?>
<!doctype html>
...
<script>
    ...
    function getCustomerSelect(store) {
        ...
        xhttp.open("GET", "apis/sale_customerselect.php?store=" + store+"", true);
        xhttp.send();
    }
    ...
    function getTable(value){
        ...
        xmlhttp.open("GET","apis/sale_table.php?sec2increment1="+ value +"",true);
        xmlhttp.send();
    }
    ...
    function getTable1(value){
        return new Promise((response)=> {
            ...
            xmlhttp.open("GET", "apis/sale_table1.php?sec2increment1=" + value + "", true);
            xmlhttp.send();
        });
    }
    ...
    function insertSale1(){
        return new Promise((response)=> {
            ...
            xmlhttp.open("GET","apis/insertsales1.php?date="+ date +"&store="+store+"&customer="+customer+"&cash="+cash+"&amount="+amount+"&returncash="+returncash+"",true);
            xmlhttp.send();
        });
    }
    ...
    function insertSale2(){
        return new Promise((response)=> {
            ...
            for (let j = 0; j < table.rows.length-1; j++) {
                ...
                xmlhttp.open("GET","apis/insertsale2.php?id="+ id +"&product="+table.rows[j].cells[0].innerHTML+"&price="+table.rows[j].cells[2].innerHTML+"&disc="+table.rows[j].cells[3].innerHTML+"&stax="+table.rows[j].cells[4].innerHTML+"&qty="+table.rows[j].cells[5].innerHTML+"&net="+table.rows[j].cells[6].innerHTML+"",true);
                xmlhttp.send();
            }
            response("done");
        });
    ...
    function updateExpense1(){
        return new Promise((response)=> {
            ...
            xmlhttp.open("GET","apis/updatesale1.php?id="+id+"&date="+ date +"&store="+store+"&customer="+customer+"&cash="+cash+"&amount="+amount+"&returncash="+returncash+"",true);
            xmlhttp.send();
        });
    }
    ...
    function updateExpense2(){
        return new Promise((response)=> {
            ...
            xmlhttp.open("GET","apis/updatesale2.php?id="+id+"",true);
            xmlhttp.send();
        });
    }
    ...
    function returnSale1Data(value){
        ...
        xhttp.open("GET", "apis/returnsale1data.php?id="+ value+"", true);
        xhttp.send();
    }
    ...
    function returnTable1(value){
        return new Promise((response)=> {
            ...
            xmlhttp.open("GET","apis/returnsaletable.php?id="+value+"",true);
            xmlhttp.send();
        });
    }
