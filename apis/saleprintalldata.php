...
$result3 = mysqli_query($con1, "Select sales_id as sino,tblsales1.date as date,amount as amount,cash as payment,returncash as returncash,customer as customer from tblsales1 where store='$store' AND tblsales1.date between '$from' AND '$to'");
$rows = array();
$i= 0;
