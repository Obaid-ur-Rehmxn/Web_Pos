...
$result5=mysqli_query($con1,"Update tblpurchase1 set store='$store3',date='$date',vendor='$customer3',cash='$cash',amount='$amount',returncash='$returncash' where purchase_id='$id'");
if($result5){
    echo "1";
}
else{
