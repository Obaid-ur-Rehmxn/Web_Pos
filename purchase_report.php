...
<script>
    ...
    function getData(){
        return new Promise((response)=> {
            ...
            xmlhttp.open("GET", "apis/purchaseprintalldata.php?sec2increment1=" + localStorage.getItem('store') + "&from=" + from + "&to=" + to+"", true);
            xmlhttp.send();
        });
    }
    ...
    function printData(value){
        printJS({
            ...
            header: '<h2 class="custom-h3">Purchase Report</h2>',
